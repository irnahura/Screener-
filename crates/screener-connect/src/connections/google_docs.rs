...
static OAUTH: OAuthConfig = OAuthConfig {
    ...
    extra_auth_params: &[
        (
            ...
            //   opens with screener (does NOT grant whole-Drive access;
...
static DEF: IntegrationDef = IntegrationDef {
    ...
    description: "Read and write access to Google Docs — full document content, \
        ...
        GET /connections/google-docs/proxy/drive/v3/files?q=mimeType='application/vnd.google-apps.document' — list Docs the app created or the user opened with screener. \
        GET /connections/google-docs/proxy/drive/v3/files/{fileId}/export?mimeType=text/plain — export a Doc as plain text. \
        Uses drive.file scope — only files the user explicitly opens with screener (e.g. by pasting a Doc URL) or that screener creates are visible; this is intentional privacy design. \
