...
// here so screener can offer one-click "connect with Bee" instead of asking
...
mod tests {
    ...
    ///
    ///   cargo test -p screener-connect connections::bee::tests::live_api_smoke \
    ///     -- --ignored --nocapture
    ///
