...
// screener's Zendesk OAuth app is a **global** OAuth client so a single
...
//     unique identifier `zdg-screener` (the identifier becomes the client_id).
//   * Redirect URL: https://screenpi.pe/api/oauth/callback
//   * Add OAUTH_ZENDESK_CLIENT_SECRET (+ OAUTH_ZENDESK_CLIENT_ID = zdg-screener)
//     to the screenpi.pe proxy env.
static OAUTH: OAuthConfig = OAuthConfig {
    auth_url: "https://{subdomain}.zendesk.com/oauth/authorizations/new",
    client_id: "zdg-screener",
