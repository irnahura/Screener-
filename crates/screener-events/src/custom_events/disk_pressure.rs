...
/// Published while the volume containing Screener's data directory is below
...
mod tests {
    ...
    fn event_has_stable_name_and_threshold() {
        let event = DiskSpaceLowEvent::new(123, "/tmp/screener".to_string());
