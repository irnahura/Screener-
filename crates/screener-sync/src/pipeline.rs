...
//! whether the manifest contains screener device ids, customer cursor
...
mod tests {
    ...
    async fn s3_presigned_ticket_contract_replays_verbatim() {
        ...
        Mock::given(method("PUT"))
            ...
            .and(header(
                "content-type",
                "application/vnd.screener.telemetry+jsonl",
            ))
        ...
        Mock::given(method("POST"))
            ...
            .respond_with(ResponseTemplate::new(200).set_body_json(json!({
                ...
                "headers": {
                    ...
                    "Content-Type": "application/vnd.screener.telemetry+jsonl",
