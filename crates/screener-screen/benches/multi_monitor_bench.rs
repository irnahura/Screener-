...
//!
//! Run with: cargo bench -p screener-screen --bench multi_monitor_bench
//!
...
use screener_screen::frame_comparison::{compare_histogram, FrameComparer, FrameComparisonConfig};
