...
use screener_db::CustomOcrConfig as DBCustomOcrConfig;
...
impl From<OcrEngine> for screener_db::OcrEngine {
    fn from(val: OcrEngine) -> Self {
        match val {
            OcrEngine::Unstructured => screener_db::OcrEngine::Unstructured,
            OcrEngine::Tesseract => screener_db::OcrEngine::Tesseract,
            OcrEngine::WindowsNative => screener_db::OcrEngine::WindowsNative,
            OcrEngine::AppleNative => screener_db::OcrEngine::AppleNative,
            OcrEngine::Custom(config) => {
                screener_db::OcrEngine::Custom(DBCustomOcrConfig::from(config))
            }
        }
    }
}

impl From<screener_db::OcrEngine> for OcrEngine {
    fn from(engine: screener_db::OcrEngine) -> Self {
        match engine {
            screener_db::OcrEngine::Unstructured => OcrEngine::Unstructured,
            screener_db::OcrEngine::Tesseract => OcrEngine::Tesseract,
            screener_db::OcrEngine::WindowsNative => OcrEngine::WindowsNative,
            screener_db::OcrEngine::AppleNative => OcrEngine::AppleNative,
            screener_db::OcrEngine::Custom(config) => OcrEngine::Custom(config.into()),
        }
    }
}
