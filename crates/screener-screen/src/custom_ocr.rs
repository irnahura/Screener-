...
impl From<screener_db::CustomOcrConfig> for CustomOcrConfig {
    fn from(config: screener_db::CustomOcrConfig) -> Self {
        CustomOcrConfig {
...
impl From<CustomOcrConfig> for screener_db::CustomOcrConfig {
    fn from(config: CustomOcrConfig) -> Self {
        screener_db::CustomOcrConfig {
            api_url: config.api_url,
            api_key: config.api_key,
            timeout_ms: config.timeout_ms,
        }
