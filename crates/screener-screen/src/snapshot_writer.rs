...
//!
//! Writes individual JPEG files to `~/.screener/data/YYYY-MM-DD/`
...
impl SnapshotWriter {
    ...
    ///
    /// - `base_dir`: root data directory (e.g., `~/.screener/data`)
    ...
    pub fn write(
        ...
        let _dip = screener_core::thread_priority::BackgroundWorkDip::new();
