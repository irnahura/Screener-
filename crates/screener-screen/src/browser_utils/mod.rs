...
mod tests {
    ...
    fn test_strip_emoji_badge() {
        assert_eq!(
            strip_title_badge("💬1 - screener | Discord"),
            "screener | Discord"
        );
    }
    ...
    fn test_no_badge_passthrough() {
        ...
        assert_eq!(
            strip_title_badge("GitHub - screener/screener"),
            "GitHub - screener/screener"
        );
    }
    ...
    fn test_substring_match() {
        ...
        assert!(titles_match(
            "GitHub - screener/screener: AI powered",
            "GitHub - screener/screener: AI powered by what you see"
        ));
    }
    ...
    fn test_real_desync_cases_from_data() {
        // These are real desyncs found in screener data.
