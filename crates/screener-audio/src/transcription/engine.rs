...
impl TranscriptionEngine {
    ...
    pub async fn new(
        ...
        // engine-safety check in screener-config explain the limitation.
        if !screener_core::cpu_features::has_avx2() && config.requires_avx2() {
