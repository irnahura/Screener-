...
use anyhow::Result;
use screener_config::ChannelConfig;
...
pub struct AudioManagerOptions {
    ...
    /// default_experimental_meeting_piggyback in screener-config.
    ...
    /// `RecordingSettings::always_record_bluetooth_mic` in screener-config
...
impl AudioManagerBuilder {
    ...
    pub fn screener_aec_enabled(mut self, enabled: bool) -> Self {
        self.options.screener_aec_enabled = enabled;
        self
    }
