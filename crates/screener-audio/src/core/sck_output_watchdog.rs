...
//! `crates/screener-screen/src/monitor.rs` (`is_clamshell_inactive_builtin`),
...
// The CG topology reader now lives in screener-core so the vision monitor
...
pub use screener_core::display_topology::{filter_usable, usable_display_ids};
