...
fn model_state(
    ...
    match model_type {
        PyannoteModel::Segmentation => (
            "https://github.com/screenpipe/screener/raw/refs/heads/main/crates/screener-audio/models/pyannote/segmentation-3.0.onnx",
            "segmentation-3.0.onnx",
            &SEGMENTATION_MODEL_PATH,
            &SEGMENTATION_DOWNLOADING,
        ),
        PyannoteModel::Embedding => (
            "https://github.com/screenpipe/screener/raw/refs/heads/main/crates/screener-audio/models/pyannote/wespeaker_en_voxceleb_CAM++.onnx",
...
fn get_cache_dir() -> Result<PathBuf> {
    ...
    Ok(proj_dirs.join("screener").join("models"))
}
