...
fn install_onnxruntime() {
    ...
    let target_dir = Path::new("../../apps/screener-app-tauri/src-tauri").join(pkg_name);
    ...
    let offline = env_var_truthy("CARGO_NET_OFFLINE")
        || env_var_truthy("SCREENER_SKIP_ONNX_DOWNLOAD")
    ...
    // with LNK2001 unresolved external. The screener-app crate works around
