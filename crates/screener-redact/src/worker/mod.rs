...
use screener_resource::ResourceGovernor;
use screener_sqlite_coordinator::SqliteWritePool;
use sqlx::SqlitePool;
...
impl Worker {
                        ...
                        if is_missing_object(&e) {
                            ...
                            warn!(
                                ...
                                "target table/column missing from this schema — disabling its \
                                 ...
                                 retired it?); upgrade screener to clear this"
                            );
                            disabled.push(*table);
                            continue;
                        }
    ...
    /// (screener/website#291); `UiEvents` gets the multi-column
