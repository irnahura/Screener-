...
//! Async PII redaction reconciliation for screener.
//!
//! ## Why this crate exists
//!
//! Screener captures OCR text, accessibility-tree text, audio
...
//! polling interval.
//!
//! See [issue #3185](https://github.com/screenpipe/screener/issues/3185)
//! for the full design.
//!
//! ## Layout
//!
...
pub trait Redactor: Send + Sync {
    ...
    ///
    /// See screener/website#291 for why this exists (one detection per
