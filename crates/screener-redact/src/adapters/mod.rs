...
//!    Always present.
//! 2. [`tinfoil`] — HTTP client for the screener-hosted Tinfoil
...
//!    fine-tuned `screener-pii-redactor` text model. CoreML on Mac,
//!    DirectML on Windows.
//!
...
//!    the [screener-pii-bench-image](https://github.com/screenpipe/screener-pii-bench-image)
