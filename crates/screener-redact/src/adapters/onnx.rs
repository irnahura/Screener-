...
//! (see `screener-pii-bench` + the run reports in
...
//!
//! See `screener-pii-redactor-runtime/artifacts/mdeberta_v45_phase3_onnx_int8/`
...
impl OnnxConfig {
    /// `~/.screener/models/v50_distilled6l/` by convention.
    pub fn default_model_dir() -> PathBuf {
        dirs::home_dir()
            .map(|h| h.join(".screener").join("models").join("v50_distilled6l"))
            .unwrap_or_else(|| PathBuf::from(".screener/models/v50_distilled6l"))
    }
    ...
    pub const HF_REPO_BASE: &'static str =
        "https://huggingface.co/screener/pii-redactor/resolve/main/v50_distilled6l";
