...
fn pause_uia_while_screen_locked(
    ...
    if !screener_config::screen_is_locked() {
        return false;
    }
...
/// crashing whenever they opened the **Sent Items** folder while screener was
/// recording, and that ending the screener process made the crash disappear. Its
...
mod tests {
    ...
    /// cargo test -p screener-a11y test_live_bounded_capture -- --ignored --nocapture
    #[test]
    #[ignore]
    ...
    fn test_screen_lock_pause_clears_deferred_work() {
        ...
        impl Drop for ResetScreenLock {
            fn drop(&mut self) {
                screener_config::set_screen_locked(false);
            }
        }

        let _reset = ResetScreenLock;
        screener_config::set_screen_locked(true);
    ...
    /// Run with: cargo test --package screener-accessibility test_live_all_windows -- --nocapture --ignored
    #[test]
    #[ignore]
    ...
    /// Run with: cargo test --package screener-accessibility test_live_tree_capture -- --nocapture --ignored
    #[test]
    #[ignore]
    ...
    /// Run with: cargo test --package screener-accessibility test_live_performance -- --nocapture --ignored
    #[test]
    #[ignore]
    ...
    /// Run with: cargo test --package screener-accessibility test_live_dedup -- --nocapture --ignored
    #[test]
    #[ignore]
    fn test_live_dedup() {
        unsafe {
    ...
    /// Run with: cargo test --package screener-accessibility test_live_uia_thread_lifecycle -- --nocapture --ignored
    #[test]
    #[ignore]
    ...
    /// Run with: cargo test --package screener-accessibility test_live_cpu_usage -- --nocapture --ignored
    #[test]
    #[ignore]
    ...
    /// Run with: cargo test --package screener-accessibility test_live_capture_quality -- --nocapture --ignored
    #[test]
    #[ignore]
