...
//! Based on bigbrother's event format with extensions for screener integration.
...
impl UiEvent {
    ...
    pub fn to_db_insert(&self, session_id: Option<String>) -> screener_db::InsertUiEvent {
        use screener_db::{InsertUiEvent, UiEventType};
