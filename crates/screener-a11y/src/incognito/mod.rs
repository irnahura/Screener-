...
//!
//! ```rust,no_run
//! use screener_a11y::incognito::{create_detector, is_title_private};
//!
...
/// One macOS browser Screener knows how to address through Automation.
...
mod tests {
    ...
    fn test_normal_windows_not_flagged() {
        ...
        assert!(!is_title_private("screener docs"));
