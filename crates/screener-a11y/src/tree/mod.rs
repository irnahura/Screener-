...
use screener_core::window_pattern::WindowPattern;
...
pub enum SkipReason {
    ...
    Incognito,
    /// App is in the hardcoded exclusion list (e.g. screener, keychain access).
    ExcludedApp,
...
fn apply_focused_window_filters(
    ...
    if screener_core::window_pattern::matches_any(
    ...
    if !screener_core::window_pattern::passes_includes(
