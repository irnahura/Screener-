...
//! screener-a11y: Cross-platform UI event capture for screener
//!
//! This crate provides keyboard, mouse, and accessibility-based UI event capture
//! as a third modality for screener, complementing vision (OCR) and audio.
//!
//! ## Features
//!
...
//!
//! ```rust,no_run
//! use screener_a11y::{UiRecorder, UiCaptureConfig};
//!
