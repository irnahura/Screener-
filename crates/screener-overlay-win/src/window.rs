...
fn run_message_loop(
    ...
    unsafe {
        ...
        let class = windows::core::w!("screener_overlay_pill");
        let wc = WNDCLASSEXW {
        ...
        let hwnd = CreateWindowExW(
            ...
            class,
            windows::core::w!("screener overlay"),
            WS_POPUP,
            0,
            0,
            10,
...
fn stage_class() -> windows::core::PCWSTR {
    ...
    let class = windows::core::w!("screener_overlay_drag_stage");
    ...
    unsafe {
        if ctx.stage.is_none() {
            ...
            let hwnd = CreateWindowExW(
                ...
                stage_class(),
                windows::core::w!("screener overlay drag stage"),
                WS_POPUP,
                0,
                0,
                10,
