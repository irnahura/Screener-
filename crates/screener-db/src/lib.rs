...
//! SQLite storage for everything screener captures: frames, OCR text,
...
//!   [`screener_sqlite_coordinator`]; never construct a second pool against a
...
pub use screener_sqlite_coordinator::{
