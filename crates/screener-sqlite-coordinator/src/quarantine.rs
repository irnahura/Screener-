...
/// screener has hit under heavy concurrent load: the WAL index desyncs in
...
mod tests {
    ...
    const CHILD_PHASE: &str = "SCREENER_QUARANTINE_CHILD_PHASE";
    const CHILD_DB: &str = "SCREENER_QUARANTINE_CHILD_DB";
