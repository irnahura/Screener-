...
`ollama/screener-gemma4:latest` through Pi with tools, project context,
...
local Screener database. The replay fetched 1,668 selected frame IDs into a
...
Structured app context is off by default. With the setting disabled, Screener
