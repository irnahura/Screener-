...
/// Flat accessibility node shape persisted by Screener today.
///
...
/// Diagnostics from adapting Screener's current text-oriented flat tree.
...
/// Convert Screener's current flattened accessibility nodes into a compact
