...
//!
//! e.g. `screener.2026-02-17.0.log`, `screener.2026-02-17.1.log`
//!
//! # Example
//!
//! ```no_run
//! use screener_engine::logging::SizedRollingWriter;
//!
...
mod tests {
    ...
    #[test]
    fn filename_format() {
        let name = SizedRollingWriter::filename("screener", "log", "2026-02-17", 3);
        assert_eq!(name, "screener.2026-02-17.3.log");
    }
