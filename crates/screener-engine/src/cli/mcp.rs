    ...
    match command {
        McpCommand::Setup {
            ...
            let run_command = format!(
                "uv --directory {} run screener-mcp --port {}",
            ...
            if should_download {
                ...
                let repo = "screener";
                let branch = "main";
                let target_dir = "packages/screener-mcp";
...
async fn download_mcp_directory(
    ...
    headers.insert(USER_AGENT, HeaderValue::from_static("screener-cli"));
        ...
        match item.content_type.as_str() {
            ...
            "dir" => {
                ...
                let subdir_api_url = format!(
                    "https://api.github.com/repos/{}/{}/contents/{}?ref={}",
                    "screener", "screener", item.path, "main"
                );
