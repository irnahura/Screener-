...
async fn deduplicate_existing_speaker_aliases(db: &screener_db::DatabaseManager) {
...
pub fn start_speaker_identification(
    db: Arc<screener_db::DatabaseManager>,
...
async fn auto_name_input_speaker(db: Arc<screener_db::DatabaseManager>, user_name: &str) {
...
mod tests {
    ...
    async fn seed_speaker(
        ...
        use screener_db::{AudioDevice, DeviceType};
