...
//! Sync data provider implementation for screener database.
//!
//! This module bridges the screener database with the cloud sync service,
//! providing data to upload and importing data from other machines.

use async_trait::async_trait;
use chrono::Utc;
use screener_core::sync::{BlobType, PendingBlob, SyncDataProvider, SyncError, SyncResult};
...
/// Data provider implementation for screener database.
pub struct ScreenerSyncProvider {
...
#[async_trait]
impl SyncDataProvider for ScreenerSyncProvider {
