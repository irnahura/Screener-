...
//! Lives engine-side because screener-audio cannot depend on the analytics
...
/// emitters in screener-audio and to the PostHog dashboard insights.
...
pub fn spawn_piggyback_telemetry_forwarder() {
    tokio::spawn(async move {
        let mut subscription = screener_events::subscribe_to_all_events();
