...
fn test_generic_profile_rejects_jitsi_in_unrelated_url() {
    ...
    for url in [
        ...
        "https://github.com/screenpipe/screener/issues",
...
fn test_4246_real_browsing_titles_do_not_trigger_meetings() {
    // The exact (window_title, browser_url) pairs screener captured for
    ...
    let real_browsing: &[(&str, Option<&str>)] = &[
            ...
            (
                "meet - App on Amazon Appstore",
                Some("https://github.com/screenpipe/screener/issues"),
            ),
            ...
            (
                "Issues · screener/screener · GitHub",
                Some("https://github.com/screenpipe/screener/issues"),
            ),
        ];
...
fn windows_title_sweep_ignores_calendar_named_calls_as_before() {
    ...
    for title in &[
        ...
        "Screener troubleshooting with Rajat - Google Chrome",
