...
//!
//! These endpoints proxy to the screener.pe Supabase backend, allowing users
...
/// Base URL for the screener registry API.
fn api_base_url() -> String {
    std::env::var("SCREENER_API_BASE_URL").unwrap_or_else(|_| "https://screenpi.pe".to_string())
}
...
pub async fn pipe_store_install(
    ...
    let connections: Vec<String> = screener_core::pipes::parse_frontmatter(&source_md)
