...
//! [`screener_connect::connections::browser`]; this file is a thin shell
...
use screener_connect::connections::browser::{
...
pub use screener_connect::connections::browser::BrowserBridge;
...
async fn handle_extension_socket(
    ...
    let ping_task = lifecycle.spawn(async move {
        ...
        loop {
            ...
            // require leaking axum types into screener-connect.
            if ping_transport
