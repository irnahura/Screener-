...
const DATA_KEY_DOMAIN: &[u8] = b"screener-sync-data-key-v1";
const SEARCH_KEY_DOMAIN: &[u8] = b"screener-sync-search-key-v1";
const AUTO_SYNC_PASSWORD_DOMAIN: &str = "screener-cloud-sync-v1";
...
/// "screener-cloud-sync-v1")`) so devices signed into the same account can
