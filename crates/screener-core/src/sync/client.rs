...
//! Screener cloud sync API.

use std::collections::BTreeMap;
use std::time::Duration;

use reqwest::{Client, StatusCode};
use screener_sync::destination::HttpPutDirect;
use screener_sync::{BlobDestination, PutRequest, SyncError as TransportError};
...
/// Map a `screener_sync::SyncError` to this crate's `SyncError`,
