...
//! Cloud sync module for Screener.
//!
...
//!
//! ```rust,ignore
//! use screener_core::sync::{NewUserKeyData, SyncKeys};
//!
...
//!
//! ```rust,ignore
//! use screener_core::sync::{ExistingUserKeyData, SyncKeys};
//!
...
//!
//! ```rust,ignore
//! use screener_core::sync::{encrypt_blob, BlobType};
//!
//! // Encrypt OCR text
...
//!
//! ```rust,ignore
//! use screener_core::sync::decrypt_blob;
//!
