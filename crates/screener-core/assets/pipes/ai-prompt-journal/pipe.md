...
- If Obsidian is connected: use `{vault_path}/screener/ai-prompts/`
- If Obsidian is NOT connected: use `~/.screener/ai-prompts/` as fallback (works for everyone)
