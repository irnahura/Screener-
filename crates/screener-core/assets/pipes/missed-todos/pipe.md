...
Find action items and to-dos from the last 3 days that I may have missed. Read the screener skill first. Use limit=10 per search, max 5 searches over the last 3 days. Use only screener's recorded data, not this project's files or other apps' source.
