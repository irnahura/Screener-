...
/**
 * Context management extension for screener pipes and chat.
 *
...
// content_type, q query) — guidance that only makes sense for the screener
...
// e.g. the morning-brief pipe failing to read screener-api/SKILL.md (~33K).
...
export default function (pi: ExtensionAPI) {
  ...
  pi.on("tool_result", async (event) => {
    ...
    // morning-brief pipe couldn't read screener-api/SKILL.md once it hit 33K.)
