# Screener Commercial License

Copyright (c) 2024-2026 Mediar, Inc. (dba Screener). All rights reserved.

## 1. Definitions

"Licensed Work" means the Screener software covered by this license,
including its source code and documentation, and any binaries built from
that source code.

"Licensor" means Mediar, Inc. (dba Screener).
...
prebuilt builds of Screener distributed by the Licensor. Use of official
builds is governed by the Screener Terms of Service at
...
(5) or more users at one company require a Screener Team or Enterprise
...
Versions of Screener previously released under the MIT license remain
