...
import { captureOnboardingH1FollowUp } from "@/lib/analytics";

export const SELECTED_DASHBOARD_STORAGE_KEY =
  "screener.live-view.selected-dashboard";
export const ONBOARDING_BRAIN_HANDOFF_EVENT =
  "screener:open-onboarding-live-view";
export const ONBOARDING_LIVE_VIEW_FOLLOW_UP_EVENT =
  "screener:onboarding-live-view-follow-up";

const ACTIVATIONS_STORAGE_KEY =
  "screener.live-view.onboarding-activations.v1";
const BRAIN_HANDOFF_STORAGE_KEY =
  "screener.live-view.onboarding-brain-handoff.v1";
export const USER_GOAL_STORAGE_KEY = "screener.user.goal-category.v1";
const LEGACY_HOME_FOCUS_STORAGE_KEY = "screener.home.focus.v1";
