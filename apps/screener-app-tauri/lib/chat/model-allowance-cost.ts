...
/** Only Screener-hosted requests draw on the allowance. */
export const HOSTED_PROVIDER = "screener-cloud";
...
/**
 * A warning only makes sense when Screener is paying. On a local model or the
