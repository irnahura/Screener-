...
export const PRICING_URL = screenerWebUrl("/onboarding", "https://screener.com");
export const ENTERPRISE_BUILDS_URL = screenerWebUrl("/enterprise?tab=builds", "https://screener.com");
export const ENTERPRISE_DOWNLOAD_URL = screenerWebUrl("/api/download", "https://screener.com");
...
export const E2E_FORCE_BILLING_GATE_KEY = "screener_e2e_force_billing_gate";
...
export function isDevBillingBypassEnabled() {
  ...
  if (process.env.NEXT_PUBLIC_SCREENER_FORCE_BILLING_GATE === "true") {
    return false;
  }
  return (
    process.env.TAURI_ENV_DEBUG === "true" ||
    process.env.NODE_ENV === "development" ||
    process.env.NEXT_PUBLIC_SCREENER_DEV_BILLING_BYPASS === "true" ||
...
// Show the dev-only login helper (paste a token / screener:// URL) when we are
...
export function isDevLoginEnabled() {
  return (
    process.env.NODE_ENV === "development" ||
    process.env.TAURI_ENV_DEBUG === "true" ||
    process.env.NEXT_PUBLIC_SCREENER_FORCE_BILLING_GATE === "true" ||
    !!process.env.NEXT_PUBLIC_SCREENER_WEB_URL
  );
}
