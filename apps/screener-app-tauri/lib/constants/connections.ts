...
// `IntegrationDef.id` (see crates/screener-connect/src/connections/*.rs,
...
export const CONNECTION_HARDCODED_DESCRIPTIONS: Record<string, string> = {
  ...
  "remote-agent": "Run a 24/7 agent (OpenClaw, Hermes, Claude, Codex) on your VPS, wired to screener",
  "whatsapp": "Search your WhatsApp conversations",
  "anythingllm": "Give AnythingLLM access to your screen",
  "ollama": "Connect local Ollama models to screener",
  "lmstudio": "Connect LM Studio models to screener",
  "msty": "Connect Msty models to screener",
