 ...
 *     keep the wording in sync with crates/screener-core/assets/pipes/meeting-summary/pipe.md
 *
...
export function buildMeetingSummarizeInstructions(
  ...
  const lines = [
    `search screener for what happened during this meeting and summarize it: key topics, decisions, action items.`,
    ``,
    ...
    `    -H "Authorization: Bearer $SCREENER_LOCAL_API_KEY" \\`,
