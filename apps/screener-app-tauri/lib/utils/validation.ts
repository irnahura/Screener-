...
export const aiProviderTypeSchema = z.enum(["openai", "openai-chatgpt", "native-ollama", "custom", "screener-cloud", "pi", "anthropic", "acp"]);
...
const aecModeSchema = z.enum(["off", "screener", "macos", "windows"]);
