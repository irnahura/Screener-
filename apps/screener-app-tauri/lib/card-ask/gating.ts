...
export const CARD_ASK_ARM_STORAGE_KEY = "screener_card_ask_arm";
/** Local storage key holding triggers already shown, so we never repeat one. */
export const CARD_ASK_SHOWN_STORAGE_KEY = "screener_card_ask_shown";
/** Local storage key marking that this install already logged its enrollment. */
export const CARD_ASK_ENROLLED_STORAGE_KEY = "screener_card_ask_enrolled";
