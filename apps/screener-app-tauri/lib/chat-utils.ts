 ...
 * "Current Screener connected integrations context" chat.
 */
 ...
 * emitted as a `<screener_query_context>` block, and removed from the
...
export function normalizeComposerMentionsForModel(
  ...
  return {
    modelInput: [
      "<screener_query_context>",
      "The user selected these filters in the composer. Use these exact values when querying screener; do not reinterpret the original tokens.",
      ...lines,
      "</screener_query_context>",
