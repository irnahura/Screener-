...
const EMPTY_COPY: Record<FirstRunEmptyReason, string> = {
  ...
  unknown:
    "Nothing was captured in that window. Screener keeps reading in the background as you work.",
};
      ...
      {phase === "learning" && (
        <div className="flex flex-col gap-2">
          ...
          <p className="text-[11px] leading-relaxed text-muted-foreground">
            ...
            summary of what Screener picked up shows up in a new chat.
          </p>
      ...
      {phase === "writing" && (
        <div className="flex flex-col gap-2">
          ...
          {/* No countdown. The clock measured how long we would keep waiting
              ...
              spinning. */}
          <p className="text-[11px] leading-relaxed text-muted-foreground">
            Screener saw enough. Putting the summary together now — this
            takes a few seconds.
          </p>
          {capturedApps.length > 0 && (
            <div className="flex items-center gap-2 pt-0.5">
