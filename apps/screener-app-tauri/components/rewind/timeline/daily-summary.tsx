...
const SUMMARY_CACHE_PREFIX = "screener:timeline-daily-summary:pi-v2:";
					...
					<DialogHeader>
						...
						<DialogDescription>
							{userToken
								...
								: "Daily summaries use your Screener account and the Screener Cloud auto model."}
						</DialogDescription>
					</DialogHeader>
							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="text-xs text-muted-foreground">
										...
										Screener APIs. Relevant evidence is processed by your
										configured AI model.
									</p>
								</div>
							</div>
