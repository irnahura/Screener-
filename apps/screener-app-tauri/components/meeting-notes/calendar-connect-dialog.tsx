  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Screener reads event titles, times, and attendees so meeting notes can
...
function GoogleCalendarConnect({
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Connect your Google Calendar directly. Screener uses read-only access
...
function IcsCalendarConnect({
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Paste a private or public ICS/webcal subscription URL. Screener polls
