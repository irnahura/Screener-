 ...
 *
 *   [Context from search: {"kind":"screener_share_context", ...}]\n\n<prompt>
 *
...
export type AttachedContext = {
  /** What to call the attachment, e.g. "frozen Screener snapshot". */
  label: string;
...
function describeSnapshot(payload: string): { label: string; detail: string } | null {
  try {
    ...
    if (value.kind !== "screener_share_context") return null;
    ...
    const size =
      typeof value.snapshot === "string"
        ...
        : null;
    return {
      label: "frozen Screener snapshot",
