...
// and the screener-pipe-creator SKILL.md
const PIPE_CONTEXT = `create a screener pipe that does the following.
...
export function SchedulePromptDialog({
  ...
  const handleCreate = () => {
    ...
    const userRequest = [
      ...
      ``,
      `The pipe should run this prompt against my screener data:`,
      ``,
