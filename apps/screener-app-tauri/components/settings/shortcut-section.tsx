  ...
  const handleRestoreDefaults = async () => {
    try {
      ...
      await updateSettings({
        showScreenerShortcut: defaults.showScreenerShortcut,
      ...
      try { await commands.showShortcutReminder(defaults.showScreenerShortcut); } catch (_) {}
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        <ShortcutRow type="global" shortcut="showScreenerShortcut" title="toggle screener overlay" description="show/hide the main interface" value={settings.showScreenerShortcut} />
