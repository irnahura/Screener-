...
export default function GeneralSettings() {
  ...
  const handleAutoStartChange = async (checked: boolean) => {
    ...
    try {
      ...
      toast({
        ...
        description: checked
          ? "screener will start in the background when you log in"
          : "screener won't launch at startup",
      });
    } catch (e: any) {
      handleSettingsChange({ autoStartEnabled: !checked });
      toast({
  ...
  const handleOpenVersions = async () => {
    ...
    const url = screenerWebUrl(`${path}?${params.toString()}`, "https://screener.com");
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {isManagedDeployment
                      ...
                      : "Open recent stable versions on screener.com"}
                  </p>
                </div>
              </div>
              <Button
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  What you want screener to help you accomplish
                </p>
              </div>
            </div>
            <Select
