...
> = {
  work_memory: {
    firstAction:
      "Work normally for a few minutes. A useful resume point appears only after Screener observes real work and a loose end.",
    reviewAction:
  ...
  custom: {
    firstAction:
      "Use Screener normally. Your first result appears when it has enough activity to answer your request.",
    reviewAction:
...
export function LiveViewOnboardingActivation({
  ...
  const captureStatus =
    captureReadiness === "ready"
      ? { state: "ready" as const, detail: "Screener capture is on." }
    ...
    >
      <div className="grid gap-4 border-b border-border p-5 lg:grid-cols-[minmax(0,1fr)_18rem]">
        ...
        <div className="flex items-center border border-border bg-muted/20 p-4">
          ...
          <p className="text-[11px] leading-relaxed">
            Keep Screener running. This page will reveal the dashboard as soon
        ...
        <StatusRow
          ...
          detail={
            setupStatus === "needs_retry"
              ...
              : pipesReady
                ? "Screener is ready to update this view."
      ...
      <div className="flex flex-wrap items-center gap-2 border-t border-border p-4">
        ...
        <span className="text-[11px] text-muted-foreground">
          You can leave this page. Screener keeps working.
        </span>
      </div>
    </div>
  );
