...
export const audioSearchIndex: SettingsField[] = [
  ...
  { label: "Hide screener from screen capture", keywords: ["screen share", "zoom", "screenshot", "privacy"] },
...
const getAudioEngineResolution = (
  ...
  if (requested === "screener-cloud" && !hasCloudAuth) {
    return {
      requested,
      active: fallback,
  ...
  return (
    <Card className="border-border bg-card">
      <CardContent className="px-3 py-2.5">
        ...
        >
          <Input name="vocab-word" placeholder="e.g. screener" className="h-7 text-xs flex-1" spellCheck={false} autoCorrect="off" autoCapitalize="off" />
...
export function RecordingSettings({ section }: { section: RecordingSettingsSection }) {
  ...
  // the audio engine (file at ~/.screener/audio-exclusions.json); we just
  ...
  useEffect(() => {
    ...
    const needsAecSync =
      ...
      Boolean(settings.screenerAecEnabled) !== expectedSettings.screenerAecEnabled ||
  ...
  useTauriEvent("data-dir-fallback", () => {
    toast({
      ...
      description:
        "the configured data directory could not be accessed. recordings are using the default directory (~/.screener).",
      variant: "destructive",
      duration: 10000,
    });
  });
  ...
  const handleUpdate = async () => {
    ...
    if (resWriteExcl.status === "error") throw new Error(resWriteExcl.error);
      ...
      await (needsServerRestart ? commands.stopScreener() : commands.stopCapture());
      await new Promise((resolve) => setTimeout(resolve, 500));
      await (needsServerRestart ? commands.spawnScreener(null) : commands.startCapture());
      ...
      toast({
        ...
        description: needsServerRestart
          ? "Screener server restarted with new settings"
  ...
  const handleAudioTranscriptionModelChange = async (
    ...
    if (value === "screener-cloud" && !isLoggedIn) {
      return;
    }
...
Your screen is a pipe. Everything you see, hear, and type flows through it. Screener just makes sure nothing valuable leaks away.`;
      ...
      <div className="space-y-2 pt-2">
              ...
              <div className="flex min-w-0 items-center space-x-2.5">
                ...
                <div className="min-w-0">
                  <h3 className="text-sm font-medium text-foreground">
                    Hide screener from screen capture
                  </h3>
                  <p className="text-xs text-muted-foreground">
                    You&apos;ll still see screener, but it stays hidden from screenshots and anyone watching your shared screen.
                  </p>
                </div>
              </div>
              <Switch
                ...
                >
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="screener-cloud">
                        Screener Cloud{hwCapability?.recommendedEngine === "screener-cloud" && " ★"}
                      </SelectItem>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => {
                      const mode: AecMode = checked
                        ? (isMacOS ? "macos" : isWindows ? "windows" : "screener")
                        : "off";
        ...
        <Card className="border-border bg-card">
          <CardContent className="px-3 py-2.5">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center space-x-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                    Live meeting notes
                    <HelpTooltip text="Streams only the active meeting into the live note. This is separate from background 24/7 recording and can use your selected transcription engine, screener cloud, or a direct provider." />
                  </h3>
                ...
                {(settings.meetingLiveTranscriptionEnabled ?? true) && (
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="screener-cloud">screener cloud live</SelectItem>
            ...
            {(settings.meetingLiveTranscriptionEnabled ?? true) &&
              (settings.meetingLiveTranscriptionProvider ?? "selected-engine") === "screener-cloud" &&
              !settings.user?.token && (
              <p className="mt-2 ml-[26px] text-xs text-muted-foreground">
                Log in to screener cloud to use the cloud live provider.
              </p>
            )}
            {(settings.meetingLiveTranscriptionEnabled ?? true) &&
            ...
            <div className="mt-2 pt-2 border-t border-border/50 flex items-center justify-between">
              <span className="text-xs text-muted-foreground flex items-center gap-1.5">
                ...
                <HelpTooltip text="When the meeting stops, screener appends what you typed (and the files you edited) during the meeting to the meeting note. Turn off to keep notes clean." />
              </span>
              <Switch
          ...
          <CardContent className="px-3 py-2.5">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2.5">
                ...
                <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                  Your name
                  <HelpTooltip text="Your name in transcripts. Click 'train' and speak for 30 seconds to teach screener your voice — it will recognize you across all devices using voice matching." />
                </h3>
              </div>
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center space-x-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Turn what Screener already captures into a clearer view for AI. Nothing is recorded twice.
                      </p>
                    </div>
                  </div>
      ...
      <Dialog open={voiceTraining.dialogOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="max-w-lg">
          ...
          <DialogDescription className="text-xs text-muted-foreground">
            speak naturally at your normal pace — this helps screener learn your voice
          </DialogDescription>
