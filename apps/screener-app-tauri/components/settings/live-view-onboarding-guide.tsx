  ...
  if (visibleStep === "dashboard") {
    return (
      <FocusedSpotlight
        ...
        description="Screener created this Live View for the goal you chose. It fills with your real activity."
  ...
  if (visibleStep === "waiting") {
    ...
    const description = needsRetry
      ...
      : hasResult
        ...
        : "This shows what is ready and what Screener still needs before your first result appears. You can leave this page while it works.";
    return (
      <FocusedSpotlight
