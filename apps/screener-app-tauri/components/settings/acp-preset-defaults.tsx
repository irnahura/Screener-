      ...
      return (
        ...
        >
          ...
          <p className={cn("text-muted-foreground", compact ? "text-[11px]" : "text-xs")}>
            Screener can download it for you. It runs on this computer as its
          ...
          <div className="space-y-1">
            ...
            <p className={cn("text-muted-foreground", compact ? "text-[11px]" : "text-xs")}>
              {signInCommand
                ...
                : `${info.name} signs in when you open a chat with this preset: it runs its own login and stores the credential itself. Screener never sees or stores an API key for it.`}
            </p>
          </div>
