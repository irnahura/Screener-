 ...
 * section is a thin marketing card pointing at https://screener.com/team.
 *
 * Build-mode behavior:
 ...
 *     screener.com/team-dashboard (linked from the marketing page).
 *
...
const TEAM_MARKETING_URL = screenerWebUrl("/team", "https://screener.com");
      ...
      <Card>
        <CardContent className="p-8 space-y-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold leading-tight">Bring your team to Screener</h2>
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            queries from the Screener website. The desktop app stays
