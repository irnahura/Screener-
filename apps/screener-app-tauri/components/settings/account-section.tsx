...
export const searchIndex: SettingsField[] = [
  ...
  { label: "Sign in to Screener", keywords: ["login", "log in", "sign in"] },
  { label: "Logout", keywords: ["signout", "sign out", "log out"] },
  { label: "Screener Business", keywords: ["subscription", "billing", "plan", "pro", "business", "max", "ultra", "upgrade", "manage"] },
...
const ACCOUNT_URL = screenerWebUrl("/account", "https://screener.com");
const BILLING_URL = screenerWebUrl("/account/billing", "https://screener.com");
const SUBSCRIPTION_CHECKOUT_URL = screenerWebUrl(
  "/api/subscription/checkout",
  "https://screener.com",
);
const CLOUD_SUBSCRIPTION_STATUS_URL = screenerWebUrl(
...
function syncErrorDescription(e: unknown): string {
  ...
  if (/load failed|failed to fetch|networkerror|network request failed/i.test(msg)) {
    return "screener server isn't reachable — give it a few seconds after launch and try again";
  }
  return msg;
}
      ...
      {isSignedInBusinessSubscriber ? (
        <>
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-semibold">Screener {hasNamedPlan ? planDisplayName(subscriptionPlan, isManagedDeployment) : "Business"}</h3>
              ...
              <div className="flex items-center gap-3">
                ...
                {settings.pipeSyncEnabled && (
                  <Button
                    ...
                    title={
                      isServerDown
                        ? "screener server is starting up — try again in a moment"
                        : undefined
                    }
        ...
        <>
          <Card className="p-8 flex flex-col items-center text-center">
            ...
            <h3 className="text-lg font-semibold mb-1">Sign in to Screener</h3>
            ...
            <Card className="p-5">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-semibold">
                  Screener {planDisplayName(subscriptionPlan, isManagedDeployment)}
                </h3>
          ...
          {!hasNamedPlan && (
            <Card className="p-5" data-testid="account-free-plan-card">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-semibold">Screener Free</h3>
              </div>
              <p className="text-sm text-muted-foreground mt-2">
