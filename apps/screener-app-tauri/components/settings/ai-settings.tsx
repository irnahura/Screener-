...
export function AISettings() {
  ...
  // toggling this also rewrites the screener-api skill markdown so
            ...
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground/60 mt-0.5">
                  ...
                  use screener cloud. relevant activity is processed only when
                  needed.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                  ...
                  <HelpTooltip text="Lets Pi and Claude Code call screener's confidential enclave (Gemma 4 E4B inside a Tinfoil-attested AMD SEV-SNP container, encrypted in flight + at rest, no plaintext at the provider) to transcribe meetings, describe video clips, and analyze image frames from your screener data. When off, the capability is stripped from the agent skill markdown so Pi won't try to use it." />
                </h3>
                <p className="text-xs text-muted-foreground">
