 ...
 * choice and config. Screener hosts the conversation and supplies context —
 ...
 * or that picking a model in Screener changes the agent's model. It does
  ...
  return [
    {
      ...
      owner: "agent",
      detail: `You sign in to ${agentName} itself. Your Screener plan does not pay for it.`,
    },
    {
      what: "Model choice",
      owner: "agent",
      detail: `Set the model inside ${agentName}. The model picker in Screener presets does not apply.`,
    },
    {
      what: "API keys in AI presets",
      owner: "screener",
      detail: `Used for Screener's own AI. They are not passed to ${agentName}.`,
    },
    {
      what: "Screen and audio context",
      owner: "screener",
      detail: `Screener supplies what you have seen, said, and heard as tools ${agentName} can call.`,
    },
    {
...
export function AcpBoundaries({
  ...
  return (
    ...
    >
      ...
      >
        What {agentName} controls, and what Screener controls
      </p>
        ...
        {rows.map((row) => (
          <div key={row.what} className="flex flex-col gap-0.5">
            <div className="flex items-baseline gap-1.5">
              ...
              >
                {row.owner === "agent" ? agentName : "Screener"}
              </span>
            </div>
            <dd
              className={cn(
