...
export function DisplaySection() {
  ...
  // re-render) so we never fire two overlapping screener restarts.
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        {/* Disable Timeline / rewind. Gates timeline-only backend work
            ...
            unlike the other display toggles it needs a full screener restart
              ...
              <ManagedSwitch
                ...
                onCheckedChange={async (checked) => {
                  ...
                  try {
                    ...
                    // The screener shortcut only opens the timeline, so its
                    ...
                    try {
                      ...
                      toast({
                        ...
                        description: "screener restarted to apply the change.",
                      });
                    } catch (e) {
                      toast({
                        title: "failed to restart screener",
                        description: "restart screener manually to apply the change.",
                        variant: "destructive",
                      });
                    }
                  } finally {
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                    ...
                    <HelpTooltip text="When enabled, the screener overlay can appear in OBS or Screen Studio. The broader 'Hide screener from screen capture' preference in Audio & meetings takes priority." />
                  </h3>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2.5">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                      Hide Dock Icon
                      <HelpTooltip text="Run screener as a menu-bar-only app with no icon in the Dock. The menu-bar (tray) icon stays — click it to open screener. Useful if you only need the app occasionally and don't want it in the Dock." />
                    </h3>
                    <p className="text-xs text-muted-foreground">
                      Menu bar only — keep screener out of the Dock
                    </p>
                  </div>
                </div>
                <Switch
                  ...
                  onCheckedChange={async (checked) => {
                    ...
                    toast({
                      title: checked
                        ...
                        : "dock icon visible",
                      description: checked
                        ? "open screener from the menu bar icon."
                        : undefined,
                    });
                  }}
                />
                ...
                <div className="flex items-center space-x-2.5">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                      ...
                      <HelpTooltip text="When enabled, clicking the X on the Home window hides it and removes it from the Windows taskbar. screener keeps running in the system tray — click the tray icon to bring the window back." />
                    </h3>
                    <p className="text-xs text-muted-foreground">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => {
                    ...
                    toast({
                      ...
                      description: checked
                        ? "Click the tray icon to bring screener back."
                        : undefined,
                    });
                  }}
                />
        ...
        {/* Shortcut reminder advertises the screener shortcut, which only
