...
const ShortcutRow = ({
  ...
  const syncShortcuts = async (updatedShortcuts: {
    ...
    console.log("syncing shortcuts:", {
      showShortcut: updatedShortcuts.showScreenerShortcut,
    ...
    await commands.updateGlobalShortcuts(
      updatedShortcuts.showScreenerShortcut,
  ...
  const handleEnableShortcut = async (keys: string) => {
    try {
      ...
      const allShortcuts: Record<string, string> = {
        showScreenerShortcut: settings.showScreenerShortcut,
      ...
      switch (type) {
        case "global":
          ...
          const updatedShortcuts = {
            showScreenerShortcut: shortcut === "showScreenerShortcut" ? keys : settings.showScreenerShortcut,
          ...
          if (reminderShortcutKeys.has(shortcut)) {
            try {
              await commands.showShortcutReminder(updatedShortcuts.showScreenerShortcut);
            } catch (e) {
