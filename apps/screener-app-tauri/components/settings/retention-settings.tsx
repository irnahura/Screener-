      ...
      >
        <AlertDialogContent data-testid="retention-compact-dialog">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              screener will rebuild db.sqlite to return freed space to your
        ...
        <AlertDialogContent data-testid="retention-mode-confirm-dialog">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {pendingMode === "media" ? (
                <>
                  every day, screener will delete video and audio files older
                  than {retentionDays} days. transcripts, ocr text, and your
                  app/window timeline stay searchable.
                </>
              ) : pendingMode === "lean" ? (
                <>
                  every day, screener will reclaim video and audio files and
                ...
                <>
                  every day, screener will permanently delete <em>all</em>{" "}
