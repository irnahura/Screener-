    ...
    <div className="space-y-5" data-testid="section-help">
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              the complete screener tutorial, setup to scheduled tasks
            </p>
          </div>
        ...
        <button
          ...
          onClick={() => open(screenerWebUrl("/survey?utm_source=app&utm_medium=help", "https://screener.com"))}
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-sm font-medium text-foreground">Shape screener</h3>
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open(screenerWebUrl("/ideas", "https://screener.com"))}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
              screener.com/ideas →
            </button>
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open("https://github.com/screenpipe/screener/issues")}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
              open →
            </button>
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              onClick={() => open("https://discord.com/invite/screener")}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
              join →
            </button>
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open(screenerWebUrl("/changelog", "https://screener.com"))}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
              screener.com/changelog →
            </button>
          </div>
        </div>
