  ...
  return (
    <div className="space-y-3">
      <p className="text-xs text-muted-foreground leading-relaxed">
        Lets screener capture keystrokes and mouse clicks. Optional —
      ...
      <p className="text-xs text-muted-foreground">
        If the prompt doesn&apos;t appear, toggle <strong>screener</strong> on
        in System Settings → Privacy &amp; Security → Input Monitoring. Relaunch
        screener after enabling — macOS only applies TCC changes on next
        process start.
      </p>
      ...
      {suspectedGhost && !granted ? (
        <div className="rounded-md border border-red-500/30 bg-red-500/5 px-3 py-2">
          <p className="text-xs text-red-700 dark:text-red-400">
            ...
            <strong> screener </strong> on in System Settings → Privacy &amp;
      ...
      {grantedThisSession ? (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/5 px-3 py-2">
          <p className="text-xs text-amber-700 dark:text-amber-400">
            <strong>Restart screener</strong> to start capturing keystrokes
