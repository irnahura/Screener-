...
// screener_config::DeviceTier::as_str() ("high" / "mid" / "low").
...
/**
 * Restart screener if it is already running, so a choice made on an
...
function restartRunningEngine(): void {
  void (async () => {
    ...
    try {
      ...
      console.error("failed to restart screener after timeline choice:", e);
