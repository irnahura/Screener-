  ...
  const permissions: PermissionDef[] = [
    {
      ...
      subtitle: "Lets Screener transcribe your voice in meetings and calls",
    ...
    },
    {
      ...
      subtitle: "Lets Screener understand app content without OCR",
    ...
    },
    {
      ...
      subtitle: (
        <>
          Lets Screener index what&apos;s on your screen: windows, docs,
          chats, code. {" "}
      ...
      {screenRestartRequired ? (
        ...
        >
          ...
          <p className="mt-1 font-mono text-xs text-muted-foreground">
            screener won&apos;t work until you restart.
          </p>
          <button
            type="button"
          ...
          >
            ...
            />
            {restarting ? "restarting..." : "restart screener"}
          </button>
        </div>
      ) : (
        <>
