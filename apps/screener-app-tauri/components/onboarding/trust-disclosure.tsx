 ...
 */
export const PAUSE_DETAIL = "pause recording anytime from the screener icon";
 ...
 * `getDataDir()` settings helper, which reconstructs `~/.screener` and so
 * disagrees with the engine whenever the directory came from
 * `SCREENER_DATA_DIR` or a CLI flag. A trust affordance pointing at the wrong
