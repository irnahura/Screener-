...
use screener_connect::remote_sync::{self, DiscoveredHost, SyncConfig, SyncResult};
use screener_connect::sync_scheduler::SyncScheduler;
use std::path::PathBuf;
use tauri::State;

fn default_screener_dir() -> PathBuf {
...
pub async fn remote_sync_exec_setup(
    ...
    let cmd = format!("npx -y screener@latest agent setup {target}");
