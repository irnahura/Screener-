...
use screener_core::sync::{get_or_create_machine_id, SyncManager};
...
// Machine ID is now provided by screener_core::sync::get_or_create_machine_id
...
/// Trigger an immediate sync via the screener server.
#[tauri::command]
#[specta::specta]
...
/// This calls the local screener server's /data/delete-device endpoint.
