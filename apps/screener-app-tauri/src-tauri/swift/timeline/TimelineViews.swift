        ...
        ZStack {
            ...
            case .connectionError(let message):
                TimelineStatusCard(
                    ...
                    message: "Unable to reach your screener data. \(message)",
                    showsSpinner: false
                )
            }
        }
    ...
    var body: some View {
        VStack(spacing: 12) {
            ...
            Text("Building Your Memory")
                .font(.system(size: 15, weight: .semibold))
                .foregroundStyle(TimelineTheme.foreground)
            Text("Screener is recording your screen activity. Your timeline will appear here as frames are captured.")
                .font(TimelineTheme.captionFont)
                .foregroundStyle(TimelineTheme.trace)
                .multilineTextAlignment(.center)
                .frame(maxWidth: 340)
    ...
    var body: some View {
        VStack(spacing: 10) {
            ...
            Text("SCREENSHOT PAUSED")
                ...
                .foregroundStyle(TimelineTheme.foreground)
            Text("screener saved activity for this moment, but no image was saved. This usually happens during low-battery or privacy pause modes.")
                .font(TimelineTheme.captionFont)
                .foregroundStyle(TimelineTheme.trace)
                .multilineTextAlignment(.center)
                .frame(maxWidth: 340)
