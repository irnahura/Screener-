  ...
  const handleRestartServer = async () => {
    ...
    try {
      toast({
        ...
        description: "stopping screener server...",
        duration: 3000,
      });
      ...
      toast({
        title: "restarting server",
        description: "starting screener server...",
        duration: 3000,
      });
      ...
      toast({
        ...
        description: "screener server has been restarted successfully.",
        duration: 3000,
      });
    } catch (error) {
      ...
      toast({
        ...
        description: (
          <span>
            failed to restart screener server.{" "}
            <button
              type="button"
              ...
              {!hasAnyData && isHealthLoading && (
                <div className="absolute inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm">
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-sm text-muted-foreground">connecting to screener...</p>
                  </div>
                </div>
              )}
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mt-2">
                        The screener server is not running. Start the server or check permissions to continue.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Start or restart the screener server
                        </p>
                      </div>
                      <Button
                    ...
                    <>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Ensure screener has the necessary permissions to function properly
                          </p>
                        </div>
