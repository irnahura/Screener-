...
- **macOS 14.4+:** Exclude apps from system-audio capture via `~/.screener/audio-exclusions.json` (hot-reloadable JSON file; resolves bundle IDs via NSRunningApp + macOS 14.4+ `NSAudioCaptureUsageDescription` TCC prompt)
...
#### **Full Changelog:** [bdf01bdb..2b06b643](https://github.com/screenpipe/screener/compare/bdf01bdb..2b06b643)
